...
- [ruosh](https://github.com/AiDinho/ruosh) - Ruosh is a full-text search library for Python. It has a Whoosh-like API, but the search engine underneath is Tantivy.
